...
ec2_file = 'pricing-data/Amazon-Amazon-EC2-Instance-Types.csv'
azure_file = 'pricing-data/Azure-Azure-Virtual-Machines.csv'
db_file = 'pricing-data/database-pricing.csv'
df_db = pd.DataFrame(pd.read_csv("pricing-data/database-pricing.csv"))
